...
Эту задачу решает ускорение Чебышёва, которое, как можно видеть из графиков, действительно уменьшает количество итераций, необходимое для сходиомсти. К сожалению, для работы метода необходимо знать максимальное и минимальное собыственные значения матрицы, задающей СЛАУ. Максимальное собственне значение можно оценить с помощью функции Estimate_max_eigenvalue, а минимальное, к сожалению, оценить тяжело. 
